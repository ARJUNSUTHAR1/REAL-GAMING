...
const Footer = () => {
  return (
    <div className='footer'>
      ...
      <div className="footer-logo"><img src={logo}alt="" /><span>board</span></div>
      <p className='para-footer'>Playing electronic games, whether through consoles, computers, mobile phones or another medium altogether. Gaming is a nuanced term that suggests regular gameplay, possibly as a hobby.</p>
      ...
      <div className="social-accounts">
        ...
        <img src={insta} alt="" />
        <img src={github} alt="" />
        <span><h6>Copyrights 2024. all rights reserved by board</h6></span>
      </div>
    </div>
    </div>
  )
